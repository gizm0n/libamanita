#ifndef _AMANITA_GFX_TABSET_H
#define _AMANITA_GFX_TABSET_H

/**
 * @file amanita/gfx/aGfxTabset.h  
 * @author Per Löwgren
...
public:
	aGfxTabset(int id,int x=0,int y=0,int st=0);
	virtual ~aGfxTabset();
	 ...
	 **/
	static void setDefaultSettings(aGfxImage *img,aGfxFont *f1,aGfxFont *f2,Uint32 data[26]);
	...
	bool mouseDown(aGfxMouseEvent &me);
	void paint(time_t time);
};



#endif /* _AMANITA_GFX_TABSET_H */

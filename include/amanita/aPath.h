 ...
 * @see aPath::cb_move
 * */
typedef void (*path_move)(aPath &,int,int,int &,int &,int);
...
public:
	...
	aPath(int w,int h,int s,void *m,void *o,path_area_compare a,path_terrain_type t,path_move_cost c);
	~aPath();

#ifndef _AMANITA_GFX_TEXT_H
#define _AMANITA_GFX_TEXT_H

/**
 * @file amanita/gfx/aGfxText.h  
 * @author Per Löwgren
 ...
 * 
 * aGfxText insert linebreaks to adjust to the width and height of a frame.
 * @ingroup sdl
 */
class aGfxText {
private:
...
public:
	aGfxText(int w=0,int h=0,const char *str=0);
	~aGfxText();
	...
	void setFont(aGfxFont *f) { if(f && f!=font) { font = f;arrange(0); } }
	aGfxFont *getFont() { return font; }

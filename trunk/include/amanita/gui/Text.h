#ifndef _AMANITA_GUI_TEXT_H
#define _AMANITA_GUI_TEXT_H

/**
 * @file amanita/gui/Text.h  
 * @author Per Löwgren
 ...
 * 
 * Text insert linebreaks to adjust to the width and height of a frame.
 * 
 * @ingroup gui */
class Text {
private:
